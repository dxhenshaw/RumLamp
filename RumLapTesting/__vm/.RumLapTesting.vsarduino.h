/* 
	...
	Hardware: Adafruit ItsyBitsy 32u4 5V 16MHz, Platform=avr, Package=adafruit
*/
...
#define ARDUINO_AVR_ITSYBITSY32U4_5V
#define ARDUINO_ARCH_AVR
#define USB_VID 0x239A
#define USB_PID 0x800E
